...
Route::middleware('auth')->group(function () {
    ...
    Route::get('marcadas', [MarcarController::class, 'index'])->name('marcar.index');
    Route::get('marcar', [MarcarController::class, 'create'])->name('marcar.create');
    Route::post('marcar', [MarcarController::class, 'store'])->name('marcar.store');
