{{-- resources/views/permisos/edit.blade.php (ADAPTADO) --}}
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8">
                ...
                <h1 class="text-3xl font-extrabold text-indigo-400 dark:text-indigo-400 mb-6 border-b border-gray-700 dark:border-gray-700 pb-3">
                    Editar Permiso: <span class="text-white dark:text-white">{{ $permiso->nombre }}</span>
                </h1>
                ...
                <form method="POST" action="{{ route('permisos.update', $permiso) }}" 
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $permiso->nombre) }}" required 
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3"
                                  class="mt-1 block w-full bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-gray-900 dark:text-white focus:border-indigo-500 focus:ring-indigo-500 @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $permiso->descripcion) }}</textarea>
                        @error('descripcion')
                            <p class="mt-1 text-xs text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
