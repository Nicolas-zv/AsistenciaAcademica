{{-- resources/views/docentes/show.blade.php (ADAPTADO) --}}
            ...
            <div class="p-4 sm:p-8">
                ...
                <div class="bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 max-w-4xl mx-auto">
                    ...
                    <div class="mt-8 pt-4 border-t border-gray-700 text-xs text-gray-500 space-y-1">
                        <p>Registro Creado: {{ $docente->created_at->diffForHumans() }} (<span class="text-gray-400">{{ $docente->created_at->format('d/m/Y H:i') }}</span>)</p>
                        <p>Última Actualización: {{ $docente->updated_at->diffForHumans() }} (<span class="text-gray-400">{{ $docente->updated_at->format('d/m/Y H:i') }}</span>)</p>
                    </div>
