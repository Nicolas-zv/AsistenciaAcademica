{{-- resources/views/modulos/index.blade.php (ADAPTADO) --}}
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 sm:p-8">
               ...
               <h1 class="text-3xl font-extrabold text-indigo-400 mb-6 border-b border-gray-700 pb-3">
                            ...
                            @forelse ($modulos as $modulo)
                                <tr class="hover:bg-gray-700/50 transition duration-150">
                                    <td
                                        ...
                                        {{ $modulo->nombre }}</td>
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-sm font-medium text-indigo-400 dark:text-indigo-400">
                                        {{ $modulo->codigo ?? 'N/A' }}</td>
                ...
                {{-- Enlaces de paginación (si usas $modulos->links()) --}}
                @if (method_exists($modulos, 'links'))
                    <div class="mt-4">
                        {{ $modulos->links() }}
                    </div>
                @endif
