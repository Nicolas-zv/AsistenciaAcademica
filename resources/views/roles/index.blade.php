                        ...
                        <table class="min-w-full leading-normal">
                            <thead>
                                <tr class="text-left text-gray-400 border-b border-gray-700 dark:border-gray-700 bg-gray-100 dark:bg-gray-700/50">
                                    ...
                                    <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wider w-3/12 text-center whitespace-nowrap">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($roles as $role)
                                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition duration-100">
                                        ...
                                        <td class="px-5 py-3 text-sm flex space-x-3 justify-center items-center whitespace-nowrap">
                                            ...
                                            {{-- Mantengo el código comentado por si lo necesitas --}}
                                            {{--
