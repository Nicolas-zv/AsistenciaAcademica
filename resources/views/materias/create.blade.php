{{-- resources/views/materias/create.blade.php (ADAPTADO) --}}
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 dark:border-gray-700 max-w-3xl mx-auto">
                    ...
                    <form action="{{ route('materias.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            {{-- Sección de Créditos y Carga Horaria (Opcional) --}}
                            {{-- Si deseas usar estos campos, descomenta el siguiente div:
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" id="descripcion" rows="4"
                                        class="w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-md shadow-sm p-3 focus:ring-indigo-500 focus:border-indigo-500 @error('descripcion') border-red-500 @enderror">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
