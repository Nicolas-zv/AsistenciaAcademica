                ...
                <div class="bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 max-w-4xl mx-auto">
                    ...
                    <form action="{{ route('grupo_materia.store') }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 border-b border-gray-700 pb-6">
                                <h2 class="col-span-full text-lg font-semibold text-gray-300 mb-2">Detalles, Ubicación y
                                    Docente</h2>

                                {{-- Docente Asignado --}}
                                <div class="md:col-span-3">
                                    <label for="docente_id" class="block text-sm font-medium text-gray-300 mb-1">Docente
                                        Asignado</label>
                                    <select name="docente_id" id="docente_id" {{-- ... clases ... --}}>
                                ...
                                <div>
                                    ...
                                    <select name="turno" id="turno"
                                        ...
                                        <option value="" {{ old('turno') == '' ? 'selected' : '' }}>-- Seleccione
                                            --</option>
                                        <option value="Mañana" {{ old('turno') == 'Mañana' ? 'selected' : '' }}>Mañana
                                        </option>
                                        <option value="Tarde" {{ old('turno') == 'Tarde' ? 'selected' : '' }}>Tarde
                                        </option>
                                        <option value="Noche" {{ old('turno') == 'Noche' ? 'selected' : '' }}>Noche
                                        </option>
                                    </select>
                                    @error('turno')
                                        <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="estado" id="estado" required
                                        ...
                                        <option value="activo"
                                            {{ old('estado', 'activo') == 'activo' ? 'selected' : '' }}>Activo</option>
