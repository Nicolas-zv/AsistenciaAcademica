...
@section('header', 'Detalle de Grupo')
        ...
        <div class="bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 max-w-3xl mx-auto">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start">
                    ...
                    <p class="w-2/3 text-base text-white font-bold">{{ $grupo->nombre }}</p>
                </div>
            ...
            <div class="mt-8 pt-4 border-t border-gray-700 text-xs text-gray-500">
                <p>Registro Creado: {{ $grupo->created_at->diffForHumans() }} ({{ $grupo->created_at->format('d/m/Y H:i') }})</p>
                <p>Última Actualización: {{ $grupo->updated_at->diffForHumans() }} ({{ $grupo->updated_at->format('d/m/Y H:i') }})</p>
            </div>
