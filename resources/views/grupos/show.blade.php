{{-- resources/views/grupos/show.blade.php (ADAPTADO) --}}
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl border border-gray-700 dark:border-gray-700 max-w-3xl mx-auto">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <p class="w-1/3 text-sm font-medium text-gray-400">Nombre del Grupo:</p>
                            <p class="w-2/3 text-base text-white dark:text-white font-bold">{{ $grupo->nombre }}</p>
                        </div>
                        ...
                        <div class="pt-4 border-t border-gray-700 dark:border-gray-700">
                            ...
                            <div class="bg-gray-700/50 p-4 rounded-md text-gray-300 whitespace-pre-wrap border border-gray-600 dark:border-gray-600">
                                {{ $grupo->descripcion ?? 'Este grupo no tiene una descripción detallada.' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-4 border-t border-gray-700 dark:border-gray-700 text-xs text-gray-500">
                        <p>Registro Creado: **{{ $grupo->created_at->isoFormat('D MMMM YYYY, h:mm a') }}** ({{ $grupo->created_at->diffForHumans() }})</p>
                        <p>Última Actualización: **{{ $grupo->updated_at->isoFormat('D MMMM YYYY, h:mm a') }}** ({{ $grupo->updated_at->diffForHumans() }})</p>
                    </div>
